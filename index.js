        ...
        box +=
         `
           <div class="col-md-3 demo" data-category="${categories[i].strCategory}" onclick="filtersCategories('${categories[i].strCategory}');">
                ...
                <div class="name_respons">
                    <h5>${categories[i].strCategory}</h5>
                    <p class='mb-5'>${categories[i].strCategoryDescription.split(' ').slice(0, 20).join(' ')}</p>
                </div>
            </div>`;
    }
    rowData.innerHTML = box;
        ...
        box += `
            <div class="col-md-3 demo" data-id="${meals[i].strIngredient}">
                <div  class='text-center'>
                    <i class="fa-solid fa-drumstick-bite fa-4x m-auto text-center"></i>
                    <h3>${meals[i].strIngredient}</h3>
                    <P>${meals[i].strDescription.split(' ').splice(0,20).join(' ')}</P>
                </div>
            </div>`;
    }
    rowData.innerHTML = box;
